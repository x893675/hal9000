...
// tx
type TransFunc func(tx *dbr.Tx) error
func (conn *Conn) ExecTransaction(fn TransFunc) error {
	tx, err := conn.Session.Begin()
	if err != nil {
		return err
	}
...
//
//func GetTransFromCtx(ctx context.Context)  (interface{}, bool) {
//	v := ctx.Value(transCtx{})
//	return v, v != nil
//}
//
//func NewTransWithCtx(ctx context.Context, trans interface{}) context.Context {
